...
# Set SESSION_COOKIE_SECURE=true on Render.
...
DATABASE = os.environ.get("DATABASE_PATH", "hands_clothing.db")
...
def init_database():
    ...
    # Add initial products only if database is empty
...
def admin_login():
    ...
    # Admin password must be configured in Render.
...
def create_order():
    ...
    order_data = str(data.get("order_data", data))
